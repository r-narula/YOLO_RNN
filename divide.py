...
df["x_center"] = round(df["x_center"]/grids,2)
df["y_center"] = round(df["y_center"]/grids,2)
df["width"] = round(df["width"]/grids,2)
df["height"] = round(df["height"]/grids,2)
df["xmin"] = round(df["xmin"]/grids,2)
df["ymin"] = round(df["ymin"]/grids,2)
df["xmax"] = round(df["xmax"]/grids,2)
df["ymax"] = round(df["ymax"]/grids,2)
df.to_csv("grids.csv")
